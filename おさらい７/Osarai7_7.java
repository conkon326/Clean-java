   ...
   void outLine() {
    ...
    void outLine(String startend) {
        if (startend.equals("start") || startend.equals("end")) {
            System.out.println("------------------------------" + startend.toUpperCase());
        } else {
            System.out.println("------------------------------");
        }
    }
...
class Shop extends Vehicle {
  ...
  void outData() {
    ...
    super.outData();
    System.out.println(
      "チケット平均売上　>" + ticket_ave + "一人当たり" + ticket_one + "円"
    );
    System.out.println(
      "レストラン平均売上>" + restaurant_ave + "一人当たり" + restaurant_one + "円"
    );
    System.out.println(
      "売店平均売上　　　>" + foods_ave + "一人当たり" + foods_one + "円"
    );
    System.out.println(
      "グッズ平均売上　　>" + goods_ave + "一人当たり" + goods_one + "円"
    );
  }
